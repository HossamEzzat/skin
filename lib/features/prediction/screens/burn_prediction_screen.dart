...
import 'package:skin/features/prediction/screens/burn_info_screen.dart';

class BurnPredictionScreen extends StatefulWidget {
  const BurnPredictionScreen({super.key});

  @override
  State<BurnPredictionScreen> createState() => _BurnPredictionScreenState();
}

class _BurnPredictionScreenState extends State<BurnPredictionScreen> {
  ...
  void _onClassifyPressed() {
    ...
    context.read<PredictionBloc>().add(BurnPredictionRequested(_image!));
  }
  ...
  Widget _buildHeader(ThemeData theme) {
    return Row(
      ...
      children: [
        ...
        Text('Burn Classifier', style: theme.textTheme.headlineSmall),
                ...
                child: _image == null
                    ? Column(
                        ...
                        children: [
                          ...
                          Text(
                            'AI analysis will detect severity level',
